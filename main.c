...
#define width 65
#define height 25
typedef struct {int x,y;int w;}TRacket;typedef struct { int x, y;}TBall;char mas[height][width+1];TRacket racket;TBall ball;void initball(){ball.x = 2;ball.y = 2;}void Putball(){mas[ball.y][ball.x] = '*';}
